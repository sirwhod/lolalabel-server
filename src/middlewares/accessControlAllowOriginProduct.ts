...
const accessControlAllowOriginMiddlewareProduct = async (req: Request, res: Response, next: NextFunction) => {
...
export default accessControlAllowOriginMiddlewareProduct;