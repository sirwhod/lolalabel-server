...
interface ProductValidationRequest extends Request {
  body: {
    sku: string
    version: string
    newVersion: string
...
export const versionValidationMiddleware = async (req: ProductValidationRequest, res: Response, next: NextFunction) => {
  try {
...
export const newVersionValidationMiddleware = async (req: ProductValidationRequest, res: Response, next: NextFunction) => {
  try {
...
export const compositionValidationMiddleware = async (req: ProductValidationRequest, res: Response, next: NextFunction) => {
  try {
...
export const compositionINCIValidationMiddleware = async (req: ProductValidationRequest, res: Response, next: NextFunction) => {
  try {
    const { compositionINCI } = req.body;  
...
export const skuValidationMiddleware = async (req: ProductValidationRequest, res: Response, next: NextFunction) => {
  try {
    const { sku } = req.body;  
...
export const productNameValidationMiddleware = async (req: ProductValidationRequest, res: Response, next: NextFunction) => {
  try {
...
export const productLineValidationMiddleware = async (req: ProductValidationRequest, res: Response, next: NextFunction) => {
  try {
...
export const productImageValidationMiddleware = async (req: ProductValidationRequest, res: Response, next: NextFunction) => {
  try {
